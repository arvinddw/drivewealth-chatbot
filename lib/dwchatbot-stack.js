...
const { ApiKeySourceType, CfnRestApi } = require("aws-cdk-lib/aws-apigateway");
  ...
  constructor(scope, id, props) {
    ...
    */
    ...
    function setupAPI(rewardsTopicArn, userTableName) {
      ...
      // const specAPI = new apigateway.SpecRestApi(this, 'transfers', {
      //   apiDefinition: apigateway.ApiDefinition.fromAsset('schema/transfers.json'),
      // });
      ...
      // const apiDefConfig = apigateway.ApiDefinition.fromAsset('schema/transfers.json');
      // apiGateway.node.defaultChild.bodyS3Location = apiDefConfig.s3Location;
    ...
    // CDN
    const clientBucket = new Bucket(this, "RewardsWebBucket", {
    ...
    const deployment = new BucketDeployment(this, "DeployRewardsWebsite", {
      sources: [Source.asset("./web/rewards-ui/build")],
      destinationBucket: clientBucket
    });

    new CfnOutput(this, 'Rewards UI', {
